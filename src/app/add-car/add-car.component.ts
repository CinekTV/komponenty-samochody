...
export class AddCarComponent {
 constructor(private fb: FormBuilder, private carService: CarServiceService, private router:Router, private carList: CarListComponent){}
 ...
 onSubmit(): void {
  if (this.addCarForm.valid){
    ...
    this.carService.addCar(newCar).subscribe(
      (addedCar: Car) => {  // Dodaj tutaj typ Car
